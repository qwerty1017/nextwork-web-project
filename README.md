...
- I'm doing this project to build hands-on experience with AWS CI/CD tools as part of my DevOps learning journey.
- This project helps me understand how real-world deployment pipelines work in a professional environment.
...
- **VS Code Remote-SSH**: Faced repeated SSH disconnections on Windows. Fixed by setting up an Elastic IP, adding keep-alive settings, and using PowerShell for commands.
...
- **Windows users**: Run `icacls` to fix .pem key permissions before SSHing
- **SSH timeout**: Add `ServerAliveInterval 30` to your `~/.ssh/config`
- **Banner exchange timeout**: Always wait for 2/2 status checks before connecting
```

**3. Fix the git clone URL**
Change:
```
https://github.com/yourusername/nextwork-web-project.git

<br>

## Contact
If you have any questions or comments about the NextWork Web Project, please contact:
carlbenson - [billonesbenson@gmail.com](mailto:billonesbenson@gmail.com)
...
[Carl Benson Profile](https://www.linkedin.com/in/carl-benson-billones-a9ab43284/)
